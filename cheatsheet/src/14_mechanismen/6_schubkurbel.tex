...
\begin{footnotesize}
    \begin{center}
        ...
        \begin{empheq}[box=\fbox]{align*}
            ...
            \\F_{\text{stoss}} = \frac{cos(\beta) \cdot M_{an}}{sin(\alpha + \beta) \cdot R} \quad &\mid \quad sin(\alpha + \beta) = \frac{F_t}{F_p}
...
\begin{footnotesize}
    \begin{center}
        \includegraphics[width = 0.7\linewidth]{MAEIP_Kurbelschleife}
...
\begin{footnotesize}
    \begin{center}
        \includegraphics[width = 0.8\linewidth]{MAEIP_ExzentrischeKurbel}
        \begin{empheq}[box=\fbox]{align*}
